...
const InsuranceSecotr = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      const response = await fetch( 
        `${apiUrl}/worksectors/wousyu9z4m8qlbovs67q6zeh?populate=details&populate=services.heading&populate=services.image`
      );
  ...
  return (
    <section>
      ...
      <InsuranceSection worksectorData={worksectorData} />
    </section>
  );
};

export default InsuranceSecotr;
