    ...
    return (
        <section className="relative overflow-hidden w-full py-[100px] flex flex-col">
            ...
            <div className="max-w-[1280px] overflow-auto w-full mx-auto px-[20px] py-[40px] text-center">
                ...
                <div className="">
                    ...
                    <h1 className="mt-[100px] text-center font-raleway text-white/[0.64]  font-normal text-xl md:text-[40px] mb-[48px] uppercase">Tolemaica ensures
                        <span className="text-white px-2">real-time certification</span> throughSOLUTION
                    </h1>
                    ...
                    <div className="flex flex-col gap-[32px]">
                        ...
                        <p className="text-center font-outfit font-light text-base md:text-2xl max-w-[1000px] mx-auto text-white/64">
                            Our approach is structured into four key phases, each addressing a critical aspect of the user experience. This ensures a clear, step-by-step improvement process.
                        </p>
                    </div>
                ...
                <div className="">
                    ...
                    <div className="flex flex-col gap-[50px]">
                        ...
                        >
                            ...
                            <div className="flex flex-col gap-[16px]">
                                <h1 className="font-outfit font-light text-[24px] md:text-[32px]">Market Relevance</h1>
                                <p className="font-outfit text-[24px]/[28px] font-[300] tracking-wide text-white/64">Applicable to banks, fintech firms, insurers & regulatory agencies.  </p>
                            </div>
                        </div>
                        ...
                        >
                            <div className="flex flex-col lg:justify-end justify-center lg:items-end items-center gap-[16px]">
                                <h1 className="font-outfit font-light text-[24px] md:text-[32px]">Scalability</h1>
                                <p className="font-outfit text-[24px]/[28px] font-[300] tracking-wide text-white/64">Immediate API-based deployment across banking & insurance systems.</p>
                            </div>
                        ...
                        >
                            ...
                            <div className="flex flex-col gap-[16px]">
                                <h1 className="font-outfit font-light text-[24px] md:text-[32px]">Regulatory Adaptability</h1>
                                <p className="font-outfit text-[24px]/[28px] font-[300] tracking-wide text-white/64">Fully compliant with EU MiCA, Swiss DLT Act, US FinCEN, UAE VARA.</p>
                            </div>
                        </div>
                        ...
                        >
                            <div className="flex flex-col lg:justify-end justify-center lg:items-end items-center gap-[16px]">
                                <h1 className="font-outfit font-light text-[24px] md:text-[32px]">Competitive Edge</h1>
                                <p className="font-outfit text-[24px]/[28px] font-[300] tracking-wide text-white/64">AI-driven compliance & blockchain notarization leader.</p>
                            </div>
                    ...
                    <div className="mt-[100px] text-center flex flex-col md:gap-[64px] gap-[40px] max-w-[1000px] mx-auto">
                        ...
                        <Text>
                            Tolemaica's technology enhances legal certainty, regulatory compliance, and fraud prevention for financial institutions, <GradientSpan>providing a future-proof, scalable, and legally</GradientSpan> <GradientSpan>secure solution</GradientSpan> in an era
      ...
      text-[30px]/[100%] md:text-[40px]/[100%] lg:text-[72px]/[100%] md:mx-[32px]"
            ...
            <div className="max-w-[1280px] overflow-auto w-full mx-auto px-[20px] py-[40px] text-center">
                ...
                <div className="flex flex-col  gap-[16px]">
                    <Text>
                        Based on the forecast of a <GradientSpan>progressive migration</GradientSpan> of transaction collection between different financial institutions onto a blockchain network—requiring interoperability between different blockchain networks—the <GradientSpan>Proof of Concept (PoC)</GradientSpan> focused on <GradientSpan>enhancing the value of information related to interbank transactions</GradientSpan> across European institutions.
                    </Text>

                    <Text>
                        This enhancement would have an <GradientSpan>immediate impact on the upcoming issuance of</GradientSpan> <GradientSpan>official cryptocurrencies by the Central Bank Digital Currency (CBDC).</GradientSpan>
                    </Text>
                </div>

                {/* ===== Solution Section ===== */}
                <div className="p-4 mx-auto mt-8 lg:max-w-[1280px] w-full">
                    <h1 className="mt-[100px] text-center font-raleway text-white/[0.64]  font-normal text-xl md:text-[40px] mb-[48px] uppercase">THE
                    ...
                    <div className="flex flex-col w-full lg:flex-row justify-center items-center gap-4">
                        ...
                        <div className="w-full max-w-4xl mx-auto flex flex-row justify-center items-center">
                            ...
                            <div className="hidden w-full md:flex flex-col justify-center items-center text-white lg:w-[856px] md:w-[60%] md:h-[450px] border-[2px] border-white/64 rounded-[15px] px-[16px] py-[32px]">
                                ...
                                <div className=" flex flex-row justify-between items-center lg:w-[792px] w-full mx-auto  text-center px-[50px] ">
                                    <span className="w-[132px] text-[64px]/[100%] font-[400] font-outfit  text-orange-200 mb-6">1</span>
                                    <div className="h-[2px] w-[196px] bg-white/20 self-center  mx-4"></div>
                                    <span className="w-[132px] text-[64px]/[100%] font-[400] font-outfit  text-orange-200 mb-6">2</span>
                                    <div className="h-[2px] w-[196px] bg-white/20 self-center mx-4"></div>
                                    <span className="w-[132px] text-[64px]/[100%] font-[400] font-outfit  text-orange-200 mb-6">3</span>
                                </div>

                                <div className=" flex flex-row justify-between items-center lg:w-[792px] w-full mx-auto  text-center px-[20px] ">
                                    <p className="md:w-[132px] font-outfit text-[20px]/[28px] tracking-wide text-center font-extralight">Apply Library & Web Service for E -Signatures  </p>
                                    <p className="md:w-[132px] font-outfit text-[20px]/[28px] tracking-wide text-center font-extralight">Add API for Legal Certification</p>
                                    <p className="md:w-[132px] font-outfit text-[20px]/[28px] tracking-wide text-center font-extralight">Get FEA Authentication & Verification</p>
                                </div>
                            </div>
                            ...
                            <div className="md:hidden min-w-[316px] w-full flex flex-row justify-start items-start border-[2px] border-white/64 rounded-[15px] text-white px-[16px] py-[32px]">
                                ...
                                <div className="pl-5 flex flex-col justify-start items-start gap-[16px] mx-auto  text-center p-[10px] ">
                                    <span className="w-[22px] text-[40px]/[100%] font-[400] font-outfit  text-orange-200 mb-6">1</span>
                                    <div className="w-[2px] h-[24px] bg-white/20 self-center  mx-4"></div>
                                    <span className="w-[22px] text-[40px]/[100%] font-[400] font-outfit  text-orange-200 mb-6">2</span>
                                    <div className="w-[2px] h-[24px] bg-white/20 self-center mx-4"></div>
                                    <span className="w-[22px] text-[40px]/[100%] font-[400] font-outfit  text-orange-200 mb-6">3</span>
                                </div>

                                <div className="flex flex-col gap-[46px] justify-between items-center  w-[95%] mx-auto  text-center px-[20px] py-[10px]">
                                    <p className="w-[163px] h-[60px] font-outfit text-[20px]/[28px] tracking-wide text-center font-extralight">Apply Library & Web Service for E -Signatures  </p>
                                    <p className="w-[163px] h-[60px] font-outfit text-[20px]/[28px] tracking-wide text-center font-extralight">Add API for Legal Certification</p>
                                    <p className="w-[163px] h-[60px] font-outfit text-[20px]/[28px] tracking-wide text-center font-extralight">Get FEA Authentication & Verification</p>
                                </div>
                        ...
                        <div className="lg:w-[392px] md:w-[40%] w-full h-[450px] border-[2px] border-white/64 rounded-[15px] py-[32px] px-[16px] min-w-[316px] flex flex-col gap-[32px]">
                            ...
                            <h1 className=" text-center font-raleway text-white/[0.64]  font-normal text-xl md:text-[40px] uppercase">Key
                            ...
                            <p className="font-outfit font-[500] text-[24px]/[28px] tracking-[5%] flex flex-col gap-[10px] justify-center items-center">
                                <span className="bg-gradient-to-r from-[#FF9966] to-white bg-clip-text text-transparent">Legal recognition</span>
                                <span className="bg-gradient-to-r from-[#FF9966] to-white bg-clip-text text-transparent">across EU</span>
                            </p>
                            <p className="font-outfit font-[500] text-[24px]/[28px] tracking-[5%] flex flex-col gap-[10px] justify-center items-center">
                                <span className="bg-gradient-to-r from-[#FF9966] to-white bg-clip-text text-transparent">Pre-processing</span>
                                <span className="bg-gradient-to-r from-[#FF9966] to-white bg-clip-text text-transparent">certification</span>
                            </p>
                            <p className="font-outfit font-[500] text-[24px]/[28px] tracking-[5%] flex flex-col gap-[10px] justify-center items-center">
                                <span className="bg-gradient-to-r from-[#FF9966] to-white bg-clip-text text-transparent">Guaranteed </span>
                                <span className="bg-gradient-to-r from-[#FF9966] to-white bg-clip-text text-transparent">data integrity</span>
                            </p>
