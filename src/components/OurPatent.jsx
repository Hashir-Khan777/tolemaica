      ...
      <div className="w-full flex flex-col md:gap-[64px] gap-[40px]">
        ...
        <div className="w-full mx-auto flex flex-col xl:flex-row justify-center items-center  md:gap-[20px] gap-2">
          {/* {patents.map((patent, index) => ( */}
            <div
            className="patent-2 py-[12px] md:py-[62px] px-[27px] md:px-[50px] max-h-[400px] lg:h-[400px] lg:w-[300px] w-full border border-white/64 bg-black/[0.08] rounded-[20px] flex flex-row xl:flex-col justify-center items-center gap-[10px] md:gap-[60px]"
            ...
            <div
            className="patent-1 py-[12px] md:py-[62px] px-[27px] md:px-[50px] max-h-[400px] lg:h-[400px] lg:w-[300px] w-full border border-white/64 bg-black/[0.08] rounded-[20px] flex flex-row xl:flex-col justify-center items-center gap-[10px] md:gap-[60px]"
              //  className={`${index % 2 === 0 ? "patent-2" : "patent-1"
              //   } py-[12px] md:py-[62px] px-[27px] md:px-[50px] max-h-[400px] lg:h-[400px] lg:w-[300px] w-full border border-white/64 bg-black/[0.08] rounded-[20px] flex flex-row xl:flex-col justify-center items-center gap-[10px] md:gap-[60px]`}
            >
              <img
