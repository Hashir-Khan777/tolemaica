...
const FumigationProcess = ({ services }) => {
    return (
        <div className='flex flex-col max-w-[1280px] gap-[36px] justify-center items-center'>
            <div className='md:flex hidden flex-col gap-[36px] justify-center items-center'>
                ...
                <div className='grid md:grid-cols-3 grid-cols-1 lg:gap-[36px] md:gap-[10px] mx-auto'>
                    {
                        services.slice(0, 3).map((service, index) => (
                            <FumigationCard 
                                key={index} 
                                gradientText1={service.heading.light_heading} 
                                gradientText2={service.heading.dark_heading} 
                                gradientText3={service.heading.second_dark_heading} 
                                Text={service.paragraph} 
                                background={service.background || "linear-gradient(to bottom right, #1a191a, #27161b)"} 
                            />
                        ))
                    }
                </div>

                {/* Second row with 3 remaining cards */}
                <div className='grid md:grid-cols-4 grid-cols-1 lg:gap-[36px] md:gap-[10px]'>
                    {
