...
const cardsData = [
    {
        ...
        description: "Barcode printing & scanning confirm the storage/movement times of goods in warehouses.",
        gradientColors: ["#140902", "#4e2c1c"],
    },
    {
        image: "/dataclick1.png",
        title: "Legally valid certification",
        description: "Ensures that information on a product's storage times has evidentiary value.",
    ...
    },
    {
        ...
        description: "Ideal for businesses, government entities, and manufacturers.",
