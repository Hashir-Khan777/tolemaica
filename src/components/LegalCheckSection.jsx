...
const cardsData = [
  {
    ...
    description:
      "Customizable verification processes based on company or governmental requirements.",
  ...
  },
  {
    ...
    description:
      "    Connects with databases and management platforms via APIs and webservices.",
  ...
  },
  {
    ...
    description:
      "Reads and extracts text from images for automated data processing.",
  ...
  },
  {
    ...
    description:
      "    Designed to handle large-scale operations with robust security standards. ",
    gradientColors: ["#240a12", "#3f3131"],
  },
];
