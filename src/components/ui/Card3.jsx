...
function Card3({ title, description, image, gradientColors=["#140902", "#4e2c1c"] }) {
  ...
  return (
    <div 
      className="w-full md:w-[302px] md:h-[450px] h-[475px] border-2 border-white/64 rounded-[20px] backdrop-blur-[100px] p-5 flex flex-col gap-[12px] justify-center items-center text-center"
    ...
    >
      ...
      <div className="py-[12px] px-[10px] flex flex-col gap-[8px] md:gap-[16px]">
        ...
        <p className="text-gray-400 font-outfit font-[300] text-[18px] md:text-[20px]/[25px] text-center tracking-[5%]">
          {description}
        </p>
      </div>
    </div>
