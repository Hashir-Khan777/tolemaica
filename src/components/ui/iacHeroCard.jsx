...
const HeroCard = () => {
  return (
    <div
      className="w-[90%] max-w-[1200px] min-h-[400px] lg:h-[620px]  border-2 border-white/64 rounded-[24px] backdrop-blur-[10px] p-5 flex md:flex-row flex-col  gap-[30px] lg:gap-[100px] justify-center items-center text-center mx-auto my-[30px] lg:my-[50px]backdrop-blur-[10px] bg-gradient-to-br from-white/30 via-transparent to-[#FF9966]/30 "
    >
      ...
      <div className="flex flex-col items-start justify-baseline gap-[24px] md:px-0 px-10">
        <span className="md:w-max sm:w-[95%] w-[85%] mx-auto md:mx-0 font-raleway font-[500] lg:text-[48px]/[100%]  md:text-[35px]/[40.35px] text-[25px]/[30.35px] tracking-[5%] uppercase bg-gradient-to-b from-black to-[#111] text-[#FF9966]  border-[2.05px] border-white py-[12.28px] px-[50px] rounded-full">Instant</span>
