      ...
      <div className="relative z-10 flex flex-col justify-center items-center md:gap-[100px] gap-[70px] text-center lg:px-[100px] md:px-[50px] px-[20px]">
        ...
        <div className="w-full flex flex-col gap-[64px] mx-auto">
          ...
          <div className="mx-auto hidden lg:grid grid-cols-4 gap-[36px]">
            ...
            {/* Card 1 */}
            <Card2 title="Infrastructure Monitoring" description=" Certify structural conditions with timestamped images." bg={gradients[0]} />

            {/* Card 2 */}
            <Card2 title="Legal Disputes & Professional Activities" description="Provide court-admissible proof." bg={gradients[1]} />

            {/* Card 3 */}
            <Card2 title="Consumption Measurement" description="Capture utility or resource consumption." bg={gradients[2]} />

            {/* Card 4 */}
            <Card2 title=" Point of Sale Control" description="Document store conditions and activities." bg={gradients[3]} />

            {/* Card 5 */}
            <Card2 title="Insurance Claims" description=" Secure photographic evidence for claims." bg={gradients[4]} />

            {/* Card 6 */}
            <Card2 title="Packaging & Storage Inspection" description="Certify conditions before shipment or storage." bg={gradients[5]} />
